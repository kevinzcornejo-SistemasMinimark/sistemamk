    ...
    <header className="h-12 border-b bg-card flex items-center px-3 md:px-4 gap-2 sticky top-0 z-[100] w-full">
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <div className="hidden lg:flex flex-col items-center absolute left-1/2 -translate-x-1/2 bg-primary/10 px-8 py-2 rounded-2xl border-2 border-primary/40 shadow-lg min-w-[240px]">
          <span className="text-[10px] uppercase tracking-[0.2em] text-primary font-black leading-none mb-1 opacity-90">Vendedor Activo</span>
          ...
          <div className="p-3 bg-blue-50/50 border-b text-[10px] space-y-2 animate-in fade-in slide-in-from-top-1">
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-1">
              ...
              <div className="flex justify-between">
                ...
                <b className={cn(stats.rls?.productos === "Lectura OK" ? "text-emerald-600 font-bold" : "text-destructive font-bold")}>
                  {stats.rls?.productos}
                </b>
              </div>
              <div className="flex justify-between">
                <span className="text-muted-foreground">public.lotes:</span> 
                <b className={cn(stats.rls?.lotes === "Lectura OK" ? "text-emerald-600 font-bold" : "text-destructive font-bold")}>
                  {stats.rls?.lotes}
                </b>
              </div>
              <div className="flex justify-between col-span-2">
                <span className="text-muted-foreground">public.notificaciones_gestion:</span> 
                <b className={cn(stats.rls?.gestion === "Lectura/Escritura OK" ? "text-emerald-600 font-bold" : stats.rls?.gestion === "Lectura OK" ? "text-amber-600 font-bold" : "text-destructive font-bold")}>
                  {stats.rls?.gestion}
                </b>
              </div>
            </div>
